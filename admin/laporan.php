                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= ucfirst($row['jenis_setor']) ?></td>
                                    <td>Rp <?= number_format($row['jumlah'], 0, ',', '.') ?></td>
                                    <td>
                                        <button class="btn btn-sm btn-warning edit-laporan" 
                                                data-id="<?= $row['id'] ?>"
...
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Jumlah Setoran</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" <?= $sudah_ada_pemenang ? 'disabled' : '' ?>></button>
            </div>
            <form id="formEdit" method="post" action="update_laporan.php">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" <?= $sudah_ada_pemenang ? 'disabled' : '' ?>>Simpan Perubahan</button>
                </div>
            </form>
        </div>
    </div>
